...
QT_MOC_LITERAL(1, 6, 12), // "updateAdvert"
QT_MOC_LITERAL(2, 19, 0), // ""
QT_MOC_LITERAL(3, 20, 10) // "m_fileName"

    },
    "MyFTP\0updateAdvert\0\0m_fileName"
};
...
void MyFTP::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->updateAdvert((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (MyFTP::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyFTP::updateAdvert)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MyFTP::updateAdvert(QString _t1)
{
